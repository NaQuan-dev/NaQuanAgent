...
This is a member-cache template for a content-operations group. Real members, external platform identifiers, and notes must stay in a private workspace and must not be committed to the framework repository.
...
- This file records the group-to-user view for this group. The user-to-group view should be generated from membership details.
